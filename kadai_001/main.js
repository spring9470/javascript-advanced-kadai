...
start.insertAdjacentHTML('beforebegin','<p id="numberTypes"></p>');
const numberTypes = document.getElementById('numberTypes');
...
start.addEventListener('click',() => {
  ...
  // HTML要素をbutton→Pタグに書き換える
  // document.getElementById('start').innerHTML = "<p>ありがとう</p>";
